						...
						<div class="box-widget widget-module">
							...
							<div class="widget-container">
								<div class=" widget-block">
									...
									<form class="form-horizontal" method="POST" action="<?php echo e(route('updatCours', [$Cours->id])); ?>" enctype="multipart/form-data">
										<?php echo csrf_field(); ?>
										<div class="form-group">
 											<label class="col-md-2 control-label">Nom Cours :</label>
											<div class=" col-md-8">
												<input type="text" class="form-control" name="cours" id="cours" required value="<?php echo e($Cours->nomCour); ?>">
											</div>
										</div>
										<div class="form-group">
 											<label class="col-md-2 control-label">Description :</label>
											<div class=" col-md-8">
											<textarea class="form-control" id="description" name="description" required aria-required="true"><?php echo e($Cours->description); ?></textarea>											</div>
										</div>
...
</html><?php /**PATH C:\Users\BADR\Desktop\FullCalendar-4.x-Laravel-6.x\resources\views/admin/updateCours.blade.php ENDPATH**/ ?>