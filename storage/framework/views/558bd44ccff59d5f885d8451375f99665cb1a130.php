						...
						<div class="box-widget widget-module">
							...
							<div class="widget-container">
								<div class=" widget-block">
									...
									<form class="form-horizontal" method="POST" action="<?php echo e(route('uploadControle')); ?>" enctype="multipart/form-data">
                      ...
                      <select id="class" name="class" class="form-control" required>
                        <?php if(Session::has('idp')): ?>
                          ...
                          <?php $__currentLoopData = $class; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($cl->id); ?>"><?php echo e($cl->nom_class); ?></option>
                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                       <?php endif; ?>
                      </select> 
...
$(document).ready(function(){
  $('#prof').change(function () {
        if ($(this).val() != '') {
          ...
          $.ajax({
            url: "<?php echo e(route('ProfClass')); ?>",
            method: "POST",
            dataType: 'json',
            data: {
              prof: prof,
...
</html><?php /**PATH C:\Users\BADR\Desktop\FullCalendar-4.x-Laravel-6.x\resources\views/admin/addControle.blade.php ENDPATH**/ ?>