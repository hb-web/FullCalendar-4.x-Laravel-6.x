<header class="top-bar">
				<div class="container-fluid top-nav">
					...
					<div class="row">
						...
						<div class="col-md-2 responsive-fix top-mid">
							<div class="notification-nav">
								<ul class="clearfix">
									<li class="dropdown"><a href="#" data-toggle="dropdown" class="hide-small-device waves-effect">
										<i class="fa fa-envelope"></i><span class="alert-bubble"></span></a>
			...
			</header><?php /**PATH C:\Users\BADR\Desktop\FullCalendar-4.x-Laravel-6.x\resources\views/layouts/header.blade.php ENDPATH**/ ?>