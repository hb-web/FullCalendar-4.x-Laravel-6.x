						...
						<div class="box-widget widget-module">
							...
							<div class="widget-container">
								<div class=" widget-block">
									...
									<form class="form-horizontal" method="post" action="<?php echo e(route('updateMatiere', [$matieres->id])); ?>" enctype="multipart/form-data">
										<?php echo csrf_field(); ?>
										<div class="form-group">
 											<label class="col-md-2 control-label">Nom matiére :</label>
											<div class=" col-md-8">
												<input type="text" class="form-control" placeholder="Enter text" name="matiere" id="matiere" value="<?php echo e($matieres->nomMatiere); ?>" >
											</div>
										</div>
										<div class="form-group">
 											<label class="col-md-2 control-label">Filiére : <?php echo e($matieres->mfiliere); ?></label>
											<div class=" col-md-8">
											 ...
											 <!-- <option disabled="" selected="">Choisir type</option> -->
												<?php $__currentLoopData = $filieres; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $f): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
													<?php if($f->id==$matieres->mfiliere): ?>
														<option value="<?php echo e($f->id); ?>" selected><?php echo e($f->nomFiliere); ?></option>							
													<?php else: ?>
										...
										<div class="form-group">
											...
											<div class="col-md-6">
											 ...
											 <div class="col-md-2">
												<input type="text" class="form-control" value="<?php echo e($matieres->photoMat); ?>" name="file" disabled>
											</div>
...
</html><?php /**PATH C:\Users\BADR\Desktop\FullCalendar-4.x-Laravel-6.x\resources\views/admin/updateMatiere.blade.php ENDPATH**/ ?>