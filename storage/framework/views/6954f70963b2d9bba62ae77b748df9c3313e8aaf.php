...
<body>
			...
			<div class="row">
				<div class="col-xl-12">
					<div class="bradcam_text">
						<h3>Cour : <?php echo e($Examen->nom_exam); ?></h3>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="row">
				<div class="col-lg-12">
					...
					<div class="event_details_info">
						<h2>Description :</h2>
						<p><?php echo e($Examen->description_exam); ?></p>
						 
					</div>
					<h2>Document</h2>
					<iframe src="<?php echo e(asset('assets/upload/Examens/exam')); ?>/<?php echo e($Examen->file_exam); ?>" style="width:100%; height:700px;" frameborder="0" allowfullscreen="allowfullscreen" kwframeid="1" controls controlsList="nodownload"></iframe>
					<div class="comment-form">
						<h4>Mon travail</h4>
						<form class="form-contact comment_form" action="<?php echo e(url('sendExamen')); ?>" method="POST" id="commentForm" enctype="multipart/form-data">
							<?php echo csrf_field(); ?>
							<div class="row">
							  <div class="col-12">
								 <div class="form-group">
									<input class="form-control" name="PDF" id="PDF" type="file">
									<input type="hidden" name="id" value="<?php echo e($Examen->id); ?>">
								 </div>
							  </div>
						   </div>
						   <div class="form-group">
	...
	<?php else: ?> 
		...
		<H2 style="text-align: center">Ce cour a été supprimé ou désactivé veuillez contacter votre prof</H2>
	<?php endif; ?>
	<!-- footer start -->
	<footer class="footer">
...
</html><?php /**PATH C:\Users\BADR\Desktop\FullCalendar-4.x-Laravel-6.x\resources\views/eleve/mediaExamen.blade.php ENDPATH**/ ?>