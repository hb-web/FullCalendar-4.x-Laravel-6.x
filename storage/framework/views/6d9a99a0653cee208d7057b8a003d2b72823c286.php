	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('assets/images/bg-01.jpg');">
			<div class="wrap-login100 p-t-30 p-b-50">
				...
				<form class="login100-form validate-form p-b-33 p-t-5" method="POST" action="<?php echo e(url('registrer')); ?>">
					<?php echo csrf_field(); ?>  
					<?php if($errors->any()): ?>
					...
					<div class="wrap-input100 validate-input" data-validate = "ntrer votre prénom">
						<input class="input100" type="text" name="prenom" placeholder="Prénom" required>
						<span class="focus-input100" data-placeholder="&#xe82a;"></span>
					</div>

					<div class="wrap-input100 validate-input" data-validate = "Enter Téléphone">
						<input class="input100" type="tel" name="tel" placeholder="Téléphone" pattern="[0-9]{10}"	required>
						<span class="focus-input100" data-placeholder="&#xe82a;"></span>
					</div>
					...
					<div class="wrap-input100 validate-input" data-validate="Enter password">
						<input class="input100" type="password" name="pass" placeholder="Password" autocomplete="false" required>
						<span class="focus-input100" data-placeholder="&#xe80f;"></span>
					</div>

					<div class="wrap-input100 validate-input" data-validate = "confirmation password">
						<input class="input100" type="password" name="confirme" placeholder="confirmation password" required>
						<span class="focus-input100" data-placeholder="&#xe82a;"></span>
					</div>
...
</html><?php /**PATH C:\Users\BADR\Desktop\FullCalendar-4.x-Laravel-6.x\resources\views/security/register.blade.php ENDPATH**/ ?>