                                        ...
                                        <br> 
											...
											<div class="table-responsive">
												<table
													...
													<tbody>
														<?php $__currentLoopData = $eleve; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $el): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
															<tr>
																<td class="tc-center">
																	<label><b><?php echo e($el->name); ?> <?php echo e($el->prenom); ?></b></label>
																</td>
																<td class="tc-center">
																	<label><b><?php echo e($el->nom_class); ?></b></label>
																</td>	
																<td class="tc-center">
																	<label><b><?php echo e($el->nom_exam); ?></b></label>
																</td>
																<td class="tc-center">
																	<label><b><?php echo e($el->travail_etudiant); ?></b></label>
																</td>
...
</html><?php /**PATH C:\Users\BADR\Desktop\FullCalendar-4.x-Laravel-6.x\resources\views/admin/listCorectionExamen.blade.php ENDPATH**/ ?>