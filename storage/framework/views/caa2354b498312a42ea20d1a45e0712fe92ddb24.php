			...
			<div class="row">
				<div class="col-xl-12">
					<div class="bradcam_text">
						<h3>Cour : <?php echo e($cours->nomCour); ?></h3>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="row">
				<div class="col-lg-12">
					...
					<div class="event_details_info">
						<h2>Description :</h2>
						<p><?php echo e($cours->description); ?></p>
						<video controls autoplay   class="border"  >
							<source src="<?php echo e(asset('assets/upload/videos')); ?>/<?php echo e($cours->video); ?>" type="video/mp4">
						</video>
					</div>
					<h2>Document</h2>
					<iframe src="<?php echo e(asset('assets/upload/cours')); ?>/<?php echo e($cours->PDF); ?>" style="width:100%; height:700px;" frameborder="0" allowfullscreen="allowfullscreen" kwframeid="1" controls controlsList="nodownload"></iframe>
...
</html><?php /**PATH C:\Users\BADR\Desktop\FullCalendar-4.x-Laravel-6.x\resources\views/eleve/mediaCours.blade.php ENDPATH**/ ?>