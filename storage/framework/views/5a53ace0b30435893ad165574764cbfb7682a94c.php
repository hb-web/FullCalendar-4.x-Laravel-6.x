...
<body>
	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('assets/images/parent.jpg');">
			<div class="wrap-login100 p-t-30 p-b-50">
				<span class="login100-form-title p-b-41">
					LOGIN PARENTS
				</span>
				<form class="login100-form validate-form p-b-33 p-t-5" action="<?php echo e(route('checkLoginParent')); ?>" method="post">
					<?php if($errors->any()): ?>
...
</html><?php /**PATH C:\Users\hb\Desktop\FullCalendar-4.x-Laravel-6.x\resources\views/security/login_parent.blade.php ENDPATH**/ ?>