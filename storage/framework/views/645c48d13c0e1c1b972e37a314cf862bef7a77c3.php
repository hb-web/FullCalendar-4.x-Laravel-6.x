						...
						<div class="box-widget widget-module">
							...
							<div class="widget-container">
								<div class=" widget-block">
									...
									<form class="form-horizontal" method="POST" action="<?php echo e(route('uploadExam')); ?>" enctype="multipart/form-data">
										<?php echo csrf_field(); ?>
										<div class="form-group">
 											<label class="col-md-2 control-label">Nom Examen :</label>
											<div class=" col-md-8">
												<input type="text" class="form-control" name="nomExam" id="nomExam" required>
											</div>
                    </div>
                    <div class="form-group">
                     ...
                     <div class=" col-md-8">
                       <select id="filiere" name="filiere" class="form-control">
                        <option disabled="" selected="">Choisir type</option>
												<?php $__currentLoopData = $filiere; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $f): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
$(document).ready(function(){
  $('#filiere').change(function () {
        if ($(this).val() != '') {
          ...
          $.ajax({
            url: "<?php echo e(route('filiereProf')); ?>",
            method: "POST",
            data: {
              filiere: filiere,
              _token: _token
...
</html><?php /**PATH C:\Users\BADR\Desktop\FullCalendar-4.x-Laravel-6.x\resources\views/admin/addExamen.blade.php ENDPATH**/ ?>