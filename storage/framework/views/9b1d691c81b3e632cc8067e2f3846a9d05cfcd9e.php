                                            ...
                                            <table class="table table-hover table-bordered matmix-dt bg-hc-border display responsive nowrap" id="tableMatiere">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="tc-center">
                                                            <label class="label"><b>sd</b></label>

                                                        </td>
                                                        <td class="tc-center">
                                                            <label class="label "><b><a href="">sd</a></b></label>
                                                        </td>
...
</html><?php /**PATH C:\Users\BADR\Desktop\FullCalendar-4.x-Laravel-6.x\resources\views/admin/listReclamationProf.blade.php ENDPATH**/ ?>