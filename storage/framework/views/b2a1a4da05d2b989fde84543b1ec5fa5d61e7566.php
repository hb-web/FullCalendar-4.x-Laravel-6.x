<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/font-awesome.css')); ?>" type="text/css">
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/animate.css')); ?>" type="text/css">
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/waves.css')); ?>" type="text/css">
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/layout.css')); ?>" type="text/css">
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/components.css')); ?>" type="text/css">
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/plugins.css')); ?>" type="text/css">
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/common-styles.css')); ?>" type="text/css">
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/pages.css')); ?>" type="text/css">
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/responsive.css')); ?>" type="text/css">
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/matmix-iconfont.css')); ?>" type="text/css">
...
</head><?php /**PATH C:\Users\BADR\Desktop\FullCalendar-4.x-Laravel-6.x\resources\views/layouts/head.blade.php ENDPATH**/ ?>