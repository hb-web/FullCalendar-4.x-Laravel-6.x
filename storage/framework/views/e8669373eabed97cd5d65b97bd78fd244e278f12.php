													...
													<tbody>
														<?php $__currentLoopData = $lists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
															<tr>
																...
																<td class="tc-center">
																	<label><b><?php echo e($list->name); ?> <?php echo e($list->prenom); ?></b></label>
																</td>
																 
																<?php if(!$list->nomSalle==''): ?>
																	<td class="tc-center">
																		<label><b><?php echo e($list->nomSalle); ?></b></label>
																	</td>
																	<td class="tc-center">
																		<label><b><?php echo e($list->date_creation); ?></b></label>
																	</td>
																<?php else: ?>
																	<td class="tc-center">
																		<span class="label label-warning">Absent(e)</span>
																	</td>
																	<td class="tc-center">
																		<span class="label label-warning">Absent(e)</span>
																	</td>
...
</html><?php /**PATH C:\Users\hb\Desktop\Ecole-formation\resources\views/admin/listHistoriqueEtudiant.blade.php ENDPATH**/ ?>