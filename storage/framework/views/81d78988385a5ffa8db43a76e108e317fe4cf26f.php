<div class="right-aside">
			...
			<div class="tab-content">
				<div class="tab-pane active" id="coversetaion">
					...
					<div class="block-content chat-user-list">
						...
						<ul class="chat-list">
							<li>
								<a href="#"><span class="chat-avatar"><img src="<?php echo e(asset('assets/images/avatar/adellecharles.jpg')); ?>" alt="Avatar"></span><span class="chat-u-info">Adellecharles2<cite>maroc</cite></span></a>
		...
		<div class="conv-container">
			<div class="conv-u-info chat-u-online">
				<ul>
					<li class="chat-avatar"><img src="<?php echo e(asset('assets/images/avatar/adellecharles.jpg')); ?>" alt="Avatar">
					</li>
			...
			<div class="converstaion-list">
				<div class="conversation-back">
					<div class="conv-thumb">
						<img src="<?php echo e(asset('assets/images/avatar/uxceo.jpg')); ?>" alt="user">
					</div>
					<div class="conv-text">
	...
	</div><?php /**PATH C:\Users\BADR\Desktop\FullCalendar-4.x-Laravel-6.x\resources\views/layouts/rightBar.blade.php ENDPATH**/ ?>