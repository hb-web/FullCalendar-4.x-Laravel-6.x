                                ...
                                <div class="page-breadcrumb-wrap">
                                    <div class="page-breadcrumb-info">
                                        <h2 class="breadcrumb-titles">
                                            Tables list des réponse controles des éleve
                                        </h2>
                                        <ul class="list-page-breadcrumb">
                                            <li><a href="#">Accueil</a></li>
                                            <li class="active-page">list des reponse controles des éleve</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-12">
                            <div class="box-widget widget-module">
                                <div class="widget-head clearfix">
                                    ...
                                    <h4><strong> list des réponse controles des éleve</strong></h4>
                                </div>
														...
														<?php $__currentLoopData = $controles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $controle): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
															<tr>
																...
																<td class="tc-center">
															 	...
															 	<td class="tc-center">
																	<label><b><?php echo e($controle->travail_etudiant); ?></b></label>
																</td>
...
</html><?php /**PATH C:\Users\BADR\Desktop\FullCalendar-4.x-Laravel-6.x\resources\views/admin/listReponseControle.blade.php ENDPATH**/ ?>