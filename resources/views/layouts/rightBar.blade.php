			...
			<div class="tab-content">
				<div class="tab-pane active" id="coversetaion">
					...
					<div class="block-content chat-user-list">
						...
						<ul class="chat-list">
							<li>
								<a href="#"><span class="chat-avatar"><img src="{{asset('assets/images/avatar/adellecharles.jpg')}}" alt="Avatar"></span><span class="chat-u-info">Adellecharles2<cite>maroc</cite></span></a>
