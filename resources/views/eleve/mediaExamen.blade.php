			...
			<div class="row">
				<div class="col-lg-12">
					...
					<div class="event_details_info">
						<h2>Description :</h2>
						<p>{{$Examen->description_exam}}</p>
						 
					</div>
					<h2>Document</h2>
					<iframe src="{{asset('assets/upload/Examens/exam')}}/{{$Examen->file_exam}}" style="width:100%; height:700px;" frameborder="0" allowfullscreen="allowfullscreen" kwframeid="1" controls controlsList="nodownload"></iframe>
					<div class="comment-form">
						<h4>Mon travail</h4>
						<form class="form-contact comment_form" action="{{url('sendExamen')}}" method="POST" id="commentForm" enctype="multipart/form-data">
							@csrf
							<div class="row">
							  <div class="col-12">
