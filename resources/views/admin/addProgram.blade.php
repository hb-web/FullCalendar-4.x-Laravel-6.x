...
<link rel="stylesheet" href="{{asset('assets/css/waves.css')}}" type="text/css">
...
<link rel="stylesheet" href="{{asset('assets/css/common-styles.css')}}" type="text/css">
<link rel="stylesheet" href="{{asset('assets/css/pages.css')}}" type="text/css">
<link rel="stylesheet" href="{{asset('assets/css/responsive.css')}}" type="text/css">
<link rel="stylesheet" href="{{asset('assets/css/matmix-iconfont.css')}}" type="text/css">
...
<div class="page-container list-menu-view">
	...
	<div class="left-aside desktop-view">
		<div class="aside-branding">
			<a href="index.html" class="iconic-logo"><img src="{{asset('assets/images/logo-iconic.png')}}" alt="Matmix Logo">
			</a>
			<a href="index.html" class="large-logo"><img src="{{asset('assets/images/logo-large.png')}}" alt="Matmix Logo">
				...
				<div class="row">
					...
					<div class="col-md-6 col-sm-6">
						<div class="footer-right">
							<span class="footer-meta">Crée par&nbsp;<i class="fa fa-heart"></i>&nbsp;by&nbsp;<a href="http://themeforest.net/user/westilian">westilian</a></span>
						</div>
					</div>
				</div>
			</div>
...
<div class="right-aside">
		...
		<div class="tab-content">
			<div class="tab-pane active" id="coversetaion">
				...
				<div class="block-content chat-user-list">
					...
					<ul class="chat-list">
						<li>
						<a href="#"><span class="chat-avatar"><img src="{{asset('assets/images/avatar/adellecharles.jpg')}}" alt="Avatar"></span><span class="chat-u-info">Adellecharles<cite>New York</cite></span></a>
						<span class="chat-u-status"><i class="fa fa-circle"></i></span>
						</li>
						<li class="chat-u-online">
						<a href="#"><span class="chat-avatar"><img src="{{asset('assets/images/avatar/allisongrayce.jpg')}}" alt="Avatar"></span><span class="chat-u-info">Allisongrayce<cite>New York</cite></span></a>
						<span class="chat-u-status"><i class="fa fa-circle"></i></span>
						</li>
						<li class="chat-u-online">
						<a href="#"><span class="chat-avatar"><img src="{{asset('assets/images/avatar/bobbyjkane.jpg')}}" alt="Avatar"></span><span class="chat-u-info">Bobbyjkane<cite>New York</cite></span></a>
						<span class="chat-u-status"><i class="fa fa-circle"></i></span>
						</li>
						<li class="chat-u-online">
						<a href="#"><span class="chat-avatar"><img src="{{asset('assets/images/avatar/littlenono.jpg')}}" alt="Avatar"></span><span class="chat-u-info">Littlenono<cite>New York</cite></span></a>
						<span class="chat-u-status"><i class="fa fa-circle"></i></span>
						</li>
					</ul>
					...
					<ul class="chat-list">
						<li>
						<a href="#"><span class="chat-avatar"><img src="{{asset('assets/images/avatar/geeftvorm.jpg')}}" alt="Avatar"></span><span class="chat-u-info">Geeftvorm<cite>New York</cite></span></a>
						<span class="chat-u-status"><i class="fa fa-circle"></i></span>
						</li>
						<li class="chat-u-online">
						<a href="#"><span class="chat-avatar"><img src="{{asset('assets/images/avatar/amarkdalen.jpg')}}" alt="Avatar"></span><span class="chat-u-info">Amarkdalen<cite>New York</cite></span></a>
						<span class="chat-u-status"><i class="fa fa-circle"></i></span>
						</li>
						<li>
						<a href="#"><span class="chat-avatar"><img src="{{asset('assets/images/avatar/mko.jpg')}}" alt="Avatar"></span><span class="chat-u-info">Mko<cite>New York</cite></span></a>
						<span class="chat-u-status"><i class="fa fa-circle"></i></span>
						</li>
						<li>
						<a href="#"><span class="chat-avatar"><img src="{{asset('assets/images/avatar/marktimemedia.jpg')}}" alt="Avatar"></span><span class="chat-u-info">Marktimemedia<cite>New York</cite></span></a>
						<span class="chat-u-status"><i class="fa fa-circle"></i></span>
						</li>
						<li>
						<a href="#"><span class="chat-avatar"><img src="{{asset('assets/images/avatar/oykun.jpg')}}" alt="Avatar"></span><span class="chat-u-info">Oykun<cite>New York</cite></span></a>
						<span class="chat-u-status"><i class="fa fa-circle"></i></span>
						</li>
					</ul>
				</div>
	...
	<div class="conv-container">
		<div class="conv-u-info chat-u-online">
			<ul>
				<li class="chat-avatar"><img src="{{asset('assets/images/avatar/adellecharles.jpg')}}" alt="Avatar">
				</li>
		...
		<div class="converstaion-list">
			<div class="conversation-back">
				<div class="conv-thumb">
					<img src="{{asset('assets/images/avatar/uxceo.jpg')}}" alt="user">
				</div>
				<div class="conv-text">
...
<script src="{{asset('assets/js/nav-accordion.js')}}"></script>
<script src="{{asset('assets/js/hoverintent.js')}}"></script>
<script src="{{asset('assets/js/waves.js')}}"></script>
<script src="{{asset('assets/js/switchery.js')}}"></script>
<script src="{{asset('assets/js/jquery.loadmask.js')}}"></script>
...
<!--CHARTS-->
<script src="{{asset('assets/js/chart/sparkline/jquery.sparkline.js')}}"></script>
<script src="{{asset('assets/js/chart/easypie/jquery.easypiechart.min.js')}}"></script>
<script src="{{asset('assets/js/chart/flot/excanvas.min.js')}}"></script>
<script src="{{asset('assets/js/chart/flot/jquery.flot.min.js')}}"></script>
<script src="{{asset('assets/js/chart/flot/jquery.flot.time.min.js')}}"></script>
<script src="{{asset('assets/js/chart/flot/jquery.flot.stack.min.js')}}"></script>
<script src="{{asset('assets/js/chart/flot/jquery.flot.axislabels.js')}}"></script>
<script src="{{asset('assets/js/chart/flot/jquery.flot.resize.min.js')}}"></script>
<script src="{{asset('assets/js/chart/flot/jquery.flot.tooltip.min.js')}}"></script>
<script src="{{asset('assets/js/chart/flot/jquery.flot.spline.js')}}"></script>
<script src="{{asset('assets/js/chart/flot/jquery.flot.pie.min.js')}}"></script>
<script src="{{asset('assets/js/chart.init.js')}}"></script>
<script src="{{asset('assets/js/smart-resize.js')}}"></script>
<script src="{{asset('assets/js/layout.init.js')}}"></script>
<script src="{{asset('assets/js/matmix.init.js')}}"></script>
