                            ...
                            <div class="box-widget widget-module">
                                ...
                                <div class="widget-container">
                                    <div class="widget-block">
                                        <div class="row">
                                            <div class="col-md-6">
                                            <a href="{{url('AjouterExamens')}}" class="btn btn-success">Ajouter Examen</a>
                                            </div>
                                        </div>
                                        <br>
                                            ...
                                            <table class="table table-hover table-bordered matmix-dt bg-hc-border display responsive nowrap" id="tableMatiere">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="tc-center">
                                                            <label class="label"><b>{{$examen->nomFiliere}}</b></label>
                                                        </td>
                                                        <td class="tc-center">
                                                            <div class="btn-toolbar" role="toolbar">
                                                                <div class="btn-group" role="group">
                                                                    <a href="{{action('ExamenController@classNiveau',[$examen->nom_exam ,$examen->filiere])}}" class="btn btn-info">Class</a>
