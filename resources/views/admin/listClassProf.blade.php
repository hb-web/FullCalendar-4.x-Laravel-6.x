                            ...
                            <div class="box-widget widget-module">
                                ...
                                <div class="widget-container">
                                    <div class="widget-block">
                                        <div class="row">
                                            <div class="col-md-6">
											<a href="{{url('affectationProfClass')}}" class="btn btn-success">Affectation Prof Class</a>
                                            </div>
                                        </div>
                                        <br> 
												...
												<table
													...
													<tbody>
														@foreach($class as $clas)
															<tr>
																<td class="tc-center">
																	<label><b>{{$clas->nomFiliere}}</b></label>
																</td>
																<td class="tc-center">
																	<label><b>{{$clas->nom_class}}</b></label>
																</td>
																<td class="tc-center">
																	<label><b>{{$clas->name}} {{$clas->prenom}}</b></label>
																</td>
