                                                        ...
                                                        <td class="tc-center">
                                                            <div class="btn-toolbar" role="toolbar">
                                                                <div class="btn-group" role="group">
                                                                    <a href="{{action('MatiereControler@désarchiverMatiere', $ma->id)}}" class="btn btn-info">Désarchiver</a>
                                                                    <a href="{{action('MatiereControler@delateMatiere', $ma->id)}}" class="btn btn-danger">Supprimer</a>
                                                                 </div>
                                                            </div>
                                                        </td>
                                                    </tr>
