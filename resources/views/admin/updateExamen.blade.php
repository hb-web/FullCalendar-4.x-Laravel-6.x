					...
					<div class="col-md-12">
						<div class="box-widget widget-module">
							...
							<div class="widget-container">
								<div class=" widget-block">
									...
									<form class="form-horizontal" method="POST" action="{{route('ModifierExam')}}" enctype="multipart/form-data">
										@csrf
										<div class="form-group">
 											<label class="col-md-2 control-label">Nom Examen :</label>
											<div class=" col-md-8">
												<input type="text" class="form-control" name="nomExam" id="nomExam" value="{{$Examen->nom_exam}}" required>
                      <input type="hidden" name="id" value="{{$id}}">
										...
										<div class="form-group">
											...
											<div class=" col-md-8">
                      <textarea class="form-control" id="description" name="description" required aria-required="true">{{$Examen->description_exam}}</textarea>											</div>
                      ...
                      <label class="control-label">{{$Examen->file_exam}}</label>
										</div>
										<div class="form-group">
