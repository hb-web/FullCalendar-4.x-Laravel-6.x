                                                        ...
                                                        <td class="tc-center">
                                                            <div class="btn-toolbar" role="toolbar">
                                                                <div class="btn-group" role="group">
                                                                    <a href="{{action('ExamenController@desarchiverExamen', $examen->id)}}" class="btn btn-info">Désarchiver</a>
                                                                    <a href="{{action('ExamenController@delateExamen', $examen->id)}}" class="btn btn-danger">Supprimer</a>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    </tr>
